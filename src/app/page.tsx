    ...
    <div style={scrollContainerStyle}>
      <div className="text-center py-8 px-4">
        ...
        <p className="text-xl text-gray-700">
          Marvin Ridge High serves ninth through 12th-grade students and is
          located in Waxhaw. We have a college preparatory emphasis, offering a
          variety of Honors and Advanced Placement classes and an International
      ...
      <div className="text-center py-8 px-4" style={margintopStyle}>
        ...
        <p className="text-xl text-gray-700">
          ...
          School offers a Pre-Engineering Academy, a part of Union County Public
          Schools (UCPS) Career & Technical Education (CTE), that focuses on
          applying STEM knowledge to real-world problems through hands-on
          activities and projects, including courses like PLTW Intro to
          Engineering Design and Robotics.
        </p>
      </div>
      <p className="text-xl text-gray-700">
        We do not have a TSA chapter page as this is only our second year but
        here is the our
        <a
      ...
      <p>
        <h3 className="text-2xl font-semibold text-gray-900 mb-4">
          Technology/engineering classes offered at the school, course summaries
        </h3>
        <a
